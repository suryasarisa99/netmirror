...
class OTTModel {
  ...
  final String route;
  const OTTModel(
      {required this.name, required this.image, required this.route});
}

const ottList = [
  OTTModel(
      name: "Netflix", image: "assets/ott-list/nf.webp", route: "/nf-home"),
  OTTModel(
      name: "Prime Video", image: "assets/ott-list/pv.jpg", route: "/pv-home"),
];
