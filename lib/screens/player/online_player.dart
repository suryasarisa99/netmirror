...
class _BetterPlayerScreenState extends ConsumerState<BetterPlayerScreen> {
  ...
  Future<void> _initializeVideo() async {
    ...
    final url = '$API_URL/hls/${widget.data.videoId}.m3u8?in=$resourceKey';
    log("url: $url");
    final betterPlayerDataSource = BetterPlayerDataSource(
      ...
      cacheConfiguration: BetterPlayerCacheConfiguration(
        ...
        key: widget.data.videoId.toString(),
        useCache: true,
      ),
      videoExtension: "m3u8",
