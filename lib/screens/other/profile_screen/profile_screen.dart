...
// import 'package:netmirror/navbar.dart';
...
//       DatabaseHelper.instance.getAllWatchList(),
//       DatabaseHelper.instance.getAllWatchHistory()
//     ]);

//     setState(() {
//       myList = x as List<WatchItemModel>;
//       watchHistory = y as List<WatchHistoryModel>;
//       log(myList.toString());
//     });
//   }
...
//                                       child: CachedNetworkImage(
//                                         imageUrl: e.url,
//                                         // width: e.isShow ? 180 : 120,
//                                         // height: e.isShow ? 90 : 170,
//                                         height: 170,
//                                         width: 120,
//                                         cacheManager: e.isShow
//                                             ? ShowCacheManager.instance
...
//                             border: Border.all(
//                                 color:
//                                     const Color.fromARGB(153, 135, 135, 135)),
//                             borderRadius: BorderRadius.circular(8)),
//                         child: Row(
//                           children: [
//                             Icon(
...
//                         child: const Row(
//                           children: [
//                             Text("This Android App Was Created By  ",
//                                 style: TextStyle(
